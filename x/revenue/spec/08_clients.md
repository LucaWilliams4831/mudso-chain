...
Find below a list of  `mudsod` commands added with the  `x/revenue` module. You can obtain the full list by using the `mudsod -h` command. A CLI command can look like this:

```bash
mudsod query revenue params
```
