...
var _ = Describe("Convert receiving IBC to Erc20", Ordered, func() {
	...
	Describe("enabled params and registered uosmo", func() {
		...
		It("should transfer and not convert mudso", func() {
			// Register 'mudso' coin in ERC-20 keeper to validate it is not converting the coins when receiving 'mudso' thru IBC
			...
			// 1. Send mudso from Evmos to Osmosis
			...
			// check ibc mudso coins balance on Osmosis
			...
			// 2. Send mudso IBC coins from Osmosis to Evmos
			...
			// check ibc mudso coins balance on Osmosis - should be zero
			...
			// check mudso balance after transfer - should be equal to initial balance
	...
	Describe("Performing claims with registered coin", func() {
		...
		It("it should perform the claim and convert the received tokens", func() {
			...
			// should trigger claims logic and send mudso coins from claims to receiver
