...
# Initialize chain.
mudsod init test --chain-id evmos_9000-2

# Get Genesis
wget https://archive.evmos.org/mainnet/genesis.json
mv genesis.json ~/.mudsod/config/

wget -O ~/.mudsod/config/adrbook.json https://snapshot.notional.ventures/evmos/addrbook.json
