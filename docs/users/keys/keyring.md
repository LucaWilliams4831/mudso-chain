...
MY_VALIDATOR_ADDRESS=$(mudsod keys show dev0 -a)
```
...
yes $KEYPASSWD | mudsod keys add me
yes $KEYPASSWD | mudsod keys show me
# start mudsod with keyring-backend flag
mudsod --keyring-backend=file start
```
