...
```
mudsod keys add NAME --ledger
```

**Example:**

```
mudsod keys add myledger --ledger
...
```
mudsod tx bank send myledger evmos1hnmrdr0jc2ve3ycxft0gcjjtrdkncpmmkeamf9 100000pose --fees 2000pose --from myledger
```
