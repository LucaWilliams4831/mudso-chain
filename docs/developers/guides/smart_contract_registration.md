...
mudsod tx revenue register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check revenues
mudsod q revenue contract $CONTRACT
```
...
mudsod tx revenue update $CONTRACT $WITHDRAWER \
...
mudsod tx revenue cancel $CONTRACT \
--gas=700000 --gas-prices=10000pose \
--from=mm
```
